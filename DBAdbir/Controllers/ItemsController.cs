...
namespace DBAdbir.Controllers
{
    public class ItemsController : Controller
    {
        ...
        {
            var dBAdbirContext = _context.Item.Include(i => i.Category);
            return View(await dBAdbirContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var item = await _context.Item
                ...
                .FirstOrDefaultAsync(m => m.ItemId == id); //Viser detaljerne for det item der har ID'et givet ved f.eks. Items/Details/{Id}. 
            if (item == null)
            {
                return NotFound();
            }
